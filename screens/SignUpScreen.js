...
const SignUp = props => {
  ...
  return (
    <SafeAreaView>
      <Text style={{ textAlign: 'center', fontSize: 20, marginBottom: 10}} > WELCOME TO SIGN UP </Text>
      ...
      <View style={{ flex: 1, flexDirection:'row', flexWrap:'wrap', marginBottom: 50}}> 
        <FontAwesome
        name="lock"
        color="#05375a"
        size={20}
      ...
      <View style={styles.styleButtons}>
        <Text style={styles.styleInsideBtn} > AGREE </Text>
      </View>
      </TouchableOpacity>
